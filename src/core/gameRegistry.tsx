...
export const GAME_REGISTRY: Partial<Record<Scene, GameEntry>> = {
  ...
  football: { scene: withErrorBoundary(Football, 'Football'), overlay: FootballOverlay },
  'soccer-match': { scene: withErrorBoundary(SoccerMatch, 'SoccerMatch'), overlay: SoccerMatchOverlay },
}
